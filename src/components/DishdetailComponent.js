...
import { Card, CardImg, CardText, CardTitle, Breadcrumb,BreadcrumbItem ,Button, Modal,ModalHeader,ModalBody,Label,Row,Col} from 'reactstrap';
...
function RenderComments({ comments }) {
    ...
    return (
        <div className="m-1 col-12 col-md-5">
            ...
            {/* <Button onClick={CommentForm}><span className="fa fa-pencil fa-lg"></span> Submit Comment</Button> */}
        </div>
    );
}
